        ...
        fun createMessageComponent(): OnBoardingDescriptionComponent {
            return OnBoardingDescriptionComponent(
                ...
                textLinesComponent = TextLinesComponent.from(
                    textLines = listOf(
                        Pair(
                            "https://dw2d2daekmyur.cloudfront.net/message_01.svg",
                            "학교와 학년에 상관없이 고마운 친구, 관심 있는 친구에게 내 마음을 전할 수 있어요"
                        ),
                        Pair(
                            "https://dw2d2daekmyur.cloudfront.net/message_02.svg",
                            "마음함은 매일 17:00에 열리고 22:00에 닫혀요 서로의 마음은 22:00에 한꺼번에 전달돼요"
                        ),
                        Pair(
                            "https://dw2d2daekmyur.cloudfront.net/message_03.svg",
        ...
        fun createVoteComponent(): OnBoardingDescriptionComponent {
            return OnBoardingDescriptionComponent(
                ...
                textLinesComponent = TextLinesComponent.from(
                    textLines = listOf(
                        Pair(
                            "https://dw2d2daekmyur.cloudfront.net/vote_01.svg",
                            "비밀 투표는 반 친구들에 대해 서로 칭찬하는 문화를 만들기 위해 시작되었어요"
                        ),
                        Pair(
                            "https://dw2d2daekmyur.cloudfront.net/vote_02.svg",
                            "비밀 투표함은 매일 밤 23:59에 닫히고 다음날 00:00에 새로운 비밀 투표함이 열려요"
                        ),
                        Pair(
                            "https://dw2d2daekmyur.cloudfront.net/vote_03.svg",
